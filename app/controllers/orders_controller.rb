class OrdersController < ApplicationController
  ...
  def order_adress_params
   params.require(:order_adress).permit(:postcode,:prefecture_id,:municipalities,:address,:building_name,:phone_number).merge(user_id: current_user.id,item_id:@item.id, token: params[:token])
  end
